...
class RecycleChildViewAdapter(private val data:ArrayList<RecycleItem>):RecyclerView.Adapter<RecycleChildViewAdapter.ViewHolder>() {
    inner class ViewHolder( val binding: RecycleChildViewItemBinding):RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(RecycleChildViewItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
